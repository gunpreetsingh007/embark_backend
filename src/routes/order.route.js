...
const { createOrder, getOrders, paymentVerificationAndCreateOrder, getOrderById, bulkUpdateOrderStatus, getOrdersCount, updateOrdersCount } = require('../controllers/order.controller');
...
router.post('/updateOrdersCount', updateOrdersCount);
